...
//
//  Created by Eduardo Urso on 3/4/14.
//  Copyright Eduardo Urso 2014. All rights reserved.
//
// -----------------------------------------------------------------------
...
- (id)init
{
    ...
    // Hello world
    CCLabelTTF *label = [CCLabelTTF labelWithString:@"Welcome" fontName:@"Chalkduster" fontSize:36.0f];
